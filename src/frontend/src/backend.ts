...
export class Backend implements backendInterface {
    ...
    async submitRentalRequest(arg0: string, arg1: string, arg2: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitRentalRequest(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_RentalRequestStatus_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RentalRequestStatus): RentalRequestStatus {
    return from_candid_variant_n10(_uploadFile, _downloadFile, value);
}
function from_candid_RentalRequest_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RentalRequest): RentalRequest {
...
function from_candid_record_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_RentalRequestStatus_n9(_uploadFile, _downloadFile, value.status),
        borrowerEmail: value.borrowerEmail,
...
function from_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? RentalRequestStatus.pending : "approved" in value ? RentalRequestStatus.approved : "rejected" in value ? RentalRequestStatus.rejected : value;
}
...
function from_candid_vec_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_RentalRequest>): Array<RentalRequest> {
    return value.map((x)=>from_candid_RentalRequest_n7(_uploadFile, _downloadFile, x));
}
function to_candid_RentalRequestStatus_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: RentalRequestStatus): _RentalRequestStatus {
    return to_candid_variant_n12(_uploadFile, _downloadFile, value);
}
function to_candid_UserRole_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserRole): _UserRole {
    return to_candid_variant_n2(_uploadFile, _downloadFile, value);
}
function to_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: RentalRequestStatus): {
    pending: null;
} | {
    approved: null;
} | {
    ...
    return value == RentalRequestStatus.pending ? {
        pending: null
    } : value == RentalRequestStatus.approved ? {
        approved: null
    } : value == RentalRequestStatus.rejected ? {
        rejected: null
    } : value;
}
